  ...
  <v-container>
    <v-row>
      <v-col cols="10" offset="1" class="mt-8">
        <h1 class="text-h3 text-center mb-4">Privacy Policy</h1>
        <p>
          Ndole Studio built the SuperButton service as an open source project.
          ...
          Conditions, which are accessible at superbutton.app unless otherwise
        ...
        <p>
          SuperButton does use third-party services that may collect information
          used to identify you. Link to the privacy policy of third-party
          service providers used by SuperButton
        </p>
        <ul class="mb-4">
          <li>
            <a
              href="https://www.google.com/policies/privacy/privacy-policy.vue"
          ...
          <li>
            <a
              href="https://sentry.io/privacy/privacy-policy.vue"
              target="_blank"
              class="text-decoration-none"
              rel="noopener noreferrer"
              >Sentry</a
          ...
          <li>
            <a
              href="https://segment.com/legal/privacy/privacy-policy.vue"
              target="_blank"
              class="text-decoration-none"
              rel="noopener noreferrer"
              >Segment</a
        ...
        <p>This policy is effective as of 2022-12-25</p>
        ...
        <p>
          ...
          <a
            ...
            href="mailto:arnold@superbutton.app"
            >arnold@superbutton.app</a
          >.
        </p>
